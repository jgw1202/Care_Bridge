...
public class KakaoPayService {
    ...
    public KakaoPayReadyResponseDto payReady(KakaoPayReadyRequestDto dto) {
        ...
        parameters.put("approval_url", "/api/payments/kakaopay/success?order_id="+orderId);        // 결제 성공 시 URL
        parameters.put("cancel_url", "/api/chatrooms/payments/kakaopay/cancel");                   // 결제 취소 시 URL
        parameters.put("fail_url", "/api/chatrooms/payments/kakaopay/failed");                     // 결제 실패 시 URL
